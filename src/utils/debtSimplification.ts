import { Expense, Settlement, Member, SimplifiedDebtResult, DebtTransaction, MemberBalance } from '../types';
...
export function calculateGroupDebts(
  ...
  const rawDebts: DebtTransaction[] = [];
  ...
  const simplifiedDebts: DebtTransaction[] = [];
