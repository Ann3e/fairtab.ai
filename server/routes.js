...
function broadcastToGroup(req, groupId, eventName, payload) {
  try {
...
apiRouter.get('/groups/:id/expenses', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/expenses', async (req, res) => {
  try {
...
apiRouter.put('/groups/:id/expenses/:expId', async (req, res) => {
  try {
...
apiRouter.delete('/groups/:id/expenses/:expId', async (req, res) => {
  try {
...
apiRouter.get('/groups/:id/settlements', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/settlements', async (req, res) => {
  try {
...
apiRouter.get('/groups/:id/recurring', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/recurring', async (req, res) => {
  try {
    const { title, amount, paidById } = req.body;
    if (!title || !amount || !paidById) {
      return res.status(400).json({ error: 'Title, amount, and payer are required' });
...
apiRouter.get('/groups/:id/disputes', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/disputes', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/disputes/:dispId/comments', async (req, res) => {
  try {
...
apiRouter.put('/groups/:id/disputes/:dispId/resolve', async (req, res) => {
  try {
...
apiRouter.get('/groups/:id/messages', async (req, res) => {
  try {
...
apiRouter.post('/groups/:id/messages', async (req, res) => {
  try {
...
apiRouter.get('/groups/:id/activity', async (req, res) => {
  try {
...
apiRouter.post('/ai/generate-reminder', async (req, res) => {
  try {
